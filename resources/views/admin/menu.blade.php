<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item">
      ...
      <ul class="nav nav-treeview">
        @foreach(session()->get("langs") as $data)
        <li class="nav-item">
          <a href="/admin/home/{{ $data->id }}" class="nav-link">
  ...
  @endif
    ...
    <li class="nav-item{{ Request::is('admin/about/*') ? " menu-open" : "" }}">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="/admin/about/title/list" class="nav-link{{ Request::is("admin/about/title/*") ? " active" : "" }}">
            <i class="far fa-circle nav-icon"></i>
            <p>標題管理</p>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="/admin/about/about/list/3" class="nav-link{{ Request::is("admin/about/about/3/*") ? " active" : "" }}">
            <i class="far fa-circle nav-icon"></i>
            <p>優勢</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/admin/about/event/list" class="nav-link{{ Request::is("admin/about/event/*") ? " active" : "" }}">
            <i class="far fa-circle nav-icon"></i>
            <p>記事</p>
          </a>
        </li>
    ...
    <li class="nav-item{{ Request::is('admin/product/*') ? " menu-open" : "" }}">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="/admin/product/layer1/list" class="nav-link{{ Request::is("admin/product/layer1/*") ? " active" : "" }}">
            <i class="far fa-circle nav-icon"></i>
            <p>大類別管理</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/admin/product/store/list" class="nav-link{{ Request::is("admin/product/store/*") ? " active" : "" }}">
            <i class="far fa-circle nav-icon"></i>
            <p>商店管理</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="/admin/product/list" class="nav-link{{ Request::is("admin/product/list", "admin/product/add", "admin/product/edit") ? " active" : "" }}">
            <i class="far fa-circle nav-icon"></i>
            <p>商品管理</p>
          </a>
        </li>
